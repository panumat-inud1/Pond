<script lang="ts">
	...
	export let result:any = null; // : string
...
<div class="bg-secondary rounded-lg flex justify-center mb-10 "><div class="pr-2 pl-2 text-3xl text-center">Qr Code Scaner</div></div>
...
<div class={`scanner ${active ? '' : 'scanner--hidden'}`}>
	...
	<div class="scanner-tip mb-10 mt-10">
		<div>สแกนรหัส QR ด้วยกล้องของคุณสิ</div>
	</div>
</div>
